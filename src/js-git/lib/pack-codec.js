define("js-git/lib/pack-codec.js", ["js-git/lib/inflate-stream.js","js-git/lib/inflate.js","js-git/lib/deflate.js","git-sha1.js","bodec.js"], function (module, exports) { var inflateStream = require('js-git/lib/inflate-stream.js');
var staticInflate = require('js-git/lib/inflate.js');
...
function parseEntry(chunk) {
  ...
  var body = staticInflate(bodec.slice(chunk, offset));
  if (body.length !== size) {
