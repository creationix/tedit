define("ui/editor.js", ["dombuilder.js","ui/notify.js","ui/elements.js","prefs.js","ui/zoom.js","ui/applytheme.js"], function (module, exports) { "use strict";
/*global ace*/

var domBuilder = require('dombuilder.js');

var notify = require('ui/notify.js');
var $ = require('ui/elements.js');
var prefs = require('prefs.js');
var zoom = require('ui/zoom.js');
...
function setTheme(name, quiet) {
  ...
  editor.renderer.setTheme(theme.theme, function () {
    require('ui/applytheme.js')(theme);
